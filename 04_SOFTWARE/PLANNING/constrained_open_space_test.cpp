...
int main(){
 ...
 z.minimum_altitude_m=0;z.maximum_altitude_m=120;e.restrictions[0]=z;assert(!ConstrainedOpenSpace::evaluateSegment(e,{{58.995,29.995},{59.005,30.005},100}).allowed);\n e.restrictions[0]=SpatialRestriction{}; e.restrictions[0]=z; e.restrictions[0].maximum_altitude_m=120; auto envelope=ConstrainedOpenSpace::evaluateSegment(e,{{58.995,29.995},{59.005,30.005},150,80,160}); assert(!envelope.allowed);
