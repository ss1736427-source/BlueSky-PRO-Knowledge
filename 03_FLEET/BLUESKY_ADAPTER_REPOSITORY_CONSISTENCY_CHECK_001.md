...
**Status: CONTROLLED WORKING RECORD — ADAPTER IMPLEMENTATION STUB, CONFORMANCE MATRIX, REGISTRY BOUNDARY, REGISTRY FIXTURES AND PROFILE LOOKUP AMBIGUITY CONTROL RECONCILED; REAL IMPLEMENTATION/TESTING PENDING.**
